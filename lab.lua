...
function ColorLab:to_game_color()
	return to_game_color(self.a, to_srgb_from_lab(self.l, self.gr, self.by))
end
...
function ColorLab:to_alpha_game_color()
...
function ColorLab:to_game_color_array()
	return to_game_color_array(self.a, to_srgb_from_lab(self.l, self.gr, self.by))
end
...
function ColorLab:to_alpha_game_color_array()
	return to_alpha_game_color_array(self.a, to_srgb_from_lab(self.l, self.gr, self.by))
end
...
---@return Hndy.Color.GameColorArrayRgba
function ColorLab:to_premultiplied_game_color_array()
	return to_premultiplied_alpha_game_color_array(self.a, to_srgb_from_lab(self.l, self.gr, self.by))
end
...
function ColorLab.from_game_color(color)
	...
	local l, gr, by = to_lab_from_srgb(r, g, b)
